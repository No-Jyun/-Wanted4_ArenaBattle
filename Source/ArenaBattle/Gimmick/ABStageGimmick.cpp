...
AABStageGimmick::AABStageGimmick()
{
	...
	// 상태에 따라 처리하도록 맵 설정
	StateChangedActions.Add(EStageState::Ready,
	                        FOnStateChangedDelegate::CreateUObject(this, &AABStageGimmick::SetReady));
	StateChangedActions.Add(EStageState::Fight,
	                        FOnStateChangedDelegate::CreateUObject(this, &AABStageGimmick::SetFight));
	StateChangedActions.Add(EStageState::Reward,
	                        FOnStateChangedDelegate::CreateUObject(this, &AABStageGimmick::SetChooseReward));
	StateChangedActions.Add(EStageState::Next,
	                        FOnStateChangedDelegate::CreateUObject(this, &AABStageGimmick::SetChooseNext));
...
void AABStageGimmick::OnGateTriggerBeginOverlap(
	...
	const FHitResult& SweepResult)
{
	// 부딪힌 문 (Gate) 의 방향을 확인해서 적절한 소켓 위치에 새로운 스테이지 액터 생성
